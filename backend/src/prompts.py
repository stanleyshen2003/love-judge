...
我覺得你每次下班回家都沒怎麼跟我交流，這讓我有點難過。你好像總是在忙著看手機，讓我覺得不被重視。這種情況真的讓我感到很疲憊，我希望我們可以更好地溝通，這樣我們的關係才能更順利。""",
            'summarizer': """客觀分析雙方（男性與女性）的論點。列出雙方對彼此認為的問題，保持嚴肅且中立的語氣。

請以下列結構回復

男性的論點：
詳細描述男性方的觀點，重點放在他對女性方所認為的問題或行為的看法。

女性的論點：
概述女性方的論點，強調她認為男性方行為或態度上的問題。

客觀分析：
提供對雙方論據的無偏見分析，對比雙方論點的有效性與邏輯性，保持不偏袒任何一方的立場。""",
            'lawyer': """請提供有關案件的所有信息。""",
